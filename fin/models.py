...
class Item_accounts(models.Model):
	...
	p_account_name = models.CharField(max_length=100)
	p_account_official_name = models.CharField(max_length=200)
	p_account_subtype = models.CharField(max_length=20)
	p_account_type = models.CharField(max_length=20)
	date_created = models.DateTimeField(auto_now_add=True)
	date_updated = models.DateTimeField(null=True, auto_now=True)
...
class Item_account_transactions(models.Model):
	...
	p_transaction_id = models.CharField(max_length=100)
